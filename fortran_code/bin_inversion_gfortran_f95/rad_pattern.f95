...
! vertical components
!
   coef_v(1, 1) = 0.5d0 * sin2d * cos2az ! vertical SS, multiplied by -1?
   coef_v(1, 2) = -sinaz * cos2d ! vertical DS
   coef_v(1, 3) = 0.5d0 * sin2d ! vertical 45DS

   coef_v(2, 1) = sind * sin2az ! vertical SS, multiplied by -1?
...
!
   ...
   coef_r(1, 2) = -cosaz * cos2d * tan_rot ! tangential DS, rotated by rad_c, multiplied by -1?
   coef_r(1, 3) = 0.5d0 * sin2d * cos2az * rad_rot ! radial SS, rotated by rad_c, multiplied by -1?
   ...
   coef_r(2, 2) = -sinaz * cosd * tan_rot ! tangential DS, rotated by rad_c, multiplied by -1?
   coef_r(2, 3) = sind * sin2az * rad_rot ! radial SS, rotated by rad_c, multiplied by -1?
